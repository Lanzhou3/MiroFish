...
class Project:
    ...
    # 商品信息（电商爆品预测专用）
    product_info: Optional[Dict[str, Any]] = None  # 商品详情 {name, category, price, brand, features, cost}
    viral_evaluation: Optional[Dict[str, Any]] = None  # 爆品评估结果
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "viral_evaluation": self.viral_evaluation,
            "error": self.error
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        return cls(
            ...
            viral_evaluation=data.get('viral_evaluation'),
